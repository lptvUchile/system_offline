...
from src.distance.test_features_extraction import function_features_extraction
...
path_feat_in_test_lstm = f'./data/features/distance/{prefix}/{test_folder_name}/{test_name}/test/feat_lstm_raw_test_'+test_csv+'.npy'.replace('\\', '/')
path_dist_real_test = f'./data/features/distance/{prefix}/{test_folder_name}/{test_name}/test/distance_raw_test_'+test_csv+'.npy'.replace('\\', '/')
...
min_f_train_lstm_path = f"./data/features/distance/{prefix}/{test_folder_name}/{test_name}/min_temporal.npy"
max_f_train_lstm_path = f"./data/features/distance/{prefix}/{test_folder_name}/{test_name}/max_temporal.npy"
...
max_target_path = f"./data/features/distance/{prefix}/{test_folder_name}/{test_name}/max_target.npy"
