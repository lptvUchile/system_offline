...
for seed in seeds:
    ...
    if binary:
        ...
        df_train_distance_path = os.path.join(regression_results_dir, f"{seed}_train_only_distance.csv")
        df_val_distance_path = os.path.join(regression_results_dir, f"{seed}_val_only_distance.csv")
        df_test_distance_path = os.path.join(regression_results_dir, f"{seed}_test_only_distance.csv")
