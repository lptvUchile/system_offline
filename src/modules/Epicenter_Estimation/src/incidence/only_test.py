...
path_feat_in_train_lstm = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/feat_lstm_raw_train_'+feat_type+'.npy'.replace('\\', '/')
path_feat_in_train_mlp  = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/feat_mlp_raw_train_'+feat_type+'.npy'.replace('\\', '/')
distth_az_real_train      = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/incidence_raw_train_'+feat_type+'.npy'.replace('\\', '/')

path_feat_in_val_lstm = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/feat_lstm_raw_val_'+feat_type+'.npy'.replace('\\', '/')
path_feat_in_val_mlp = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/feat_mlp_raw_val_'+feat_type+'.npy'.replace('\\', '/')
path_dist_real_val = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/incidence_raw_val_'+feat_type+'.npy'.replace('\\', '/')
path_feat_in_test_lstm = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/feat_lstm_raw_test_'+feat_type+'.npy'.replace('\\', '/')
...
path_dist_real_test = f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/incidence_raw_test_'+feat_type+'.npy'.replace('\\', '/')
...
# if regression, the model will predict the incidence of the event
...
if left_right:
    ...
    tests_csv.set_index("seed", inplace=True)
    dist_real_train = dist_real_train['incidence']
    max_target = dist_real_train.max()

    labels_train = dist_real_train/max_target
    labels_val = dist_real_val['incidence']/max_target
...
if not use_cnn_features:
    np.save(f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/min_temporal.npy',min_f_train_lstm)
    np.save(f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/max_temporal.npy',max_f_train_lstm) 
    np.save(f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/min_global.npy',min_f_train_global)
    np.save(f'./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/max_global.npy',max_f_train_global)
...
for seed in seeds:
    ...
    if binary:
        ...
        tests_csv = save_regression_metrics(tests_csv = tests_csv, seed = seed, mape_dist = mae_train, mae_baz = 0, label = "train")
        tests_csv = save_regression_metrics(tests_csv = tests_csv, seed = seed, mape_dist = mae_val, mae_baz = 0, label = "val")
        tests_csv = save_regression_metrics(tests_csv = tests_csv, seed = seed, mape_dist = mae_test, mae_baz = 0, label = "test")
        ...
        df_train_incidence_path = os.path.join(regression_results_dir, f"{seed}_train_only_incidence.csv")
        df_val_incidence_path = os.path.join(regression_results_dir, f"{seed}_val_only_incidence.csv")
        df_test_incidence_path = os.path.join(regression_results_dir, f"{seed}_test_only_incidence.csv")
