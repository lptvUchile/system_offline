...
def function_features_extraction(
    ...
    for conjunto in conjuntos:
        ...
        time.sleep(5)
        feat_out = f"./data/features/incidence/{prefix}/{test_folder_name}/{test_name}/test/"
        ...
        dist_por_evento = {"event": [], "station": [], "incidence": []} #"costero": [],"evento_izquierda_estacion": []} #, "evento_izquierda_estacion": [], "evento_derecha_estacion": []}
