...
parser.add_argument("--use_raw_temporal_feat", action= argparse.BooleanOptionalAction)
parser.add_argument("--use_arcoss", action= argparse.BooleanOptionalAction)
parser.add_argument("--use_VH_angle", action= argparse.BooleanOptionalAction)
...
print(f"use_raw_temporal_feat: {use_raw_temporal_feat}")
print(f"use_arcoss: {use_arcoss}")
print(f"use_VH_angle: {use_VH_angle}")
...
if use_cnn_features:
    ...
    print(feat_in_test_lstm.shape)
    print(min_f_train_lstm.shape)
    ...
    for i in range(len(feat_in_test_lstm)):
        
        try:
            jfjf = (feat_in_test_lstm[i]-min_f_train_lstm)/(max_f_train_lstm-min_f_train_lstm)
            print(f"Indice: {i}, Shape feat_i: {feat_in_test_lstm[i].shape}, SHape min_f_train_lstm: {min_f_train_lstm.shape}")
        except:
            print(f"Indice: {i}, Shape feat_i: {feat_in_test_lstm[i].shape}, SHape min_f_train_lstm: {min_f_train_lstm.shape}")
