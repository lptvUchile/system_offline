...
from modules.Epicenter_Estimation import IncidenceModel
from modules.Epicenter_Estimation import IncidenceFeatureExtractor
...
class IncidenceWrapper:
    def __init__(self, folder_path, model_name):
        ...
        self.feature_extractor = IncidenceFeatureExtractor(
    ...
    def estimate_incidence(self, trace, time, inv):
        ...
        incidence = test_prediction[0]*self.max_target
        return incidence
